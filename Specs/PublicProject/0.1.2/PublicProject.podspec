Pod::Spec.new do |spec|
  ...
  spec.subspec 'BaseViewController' do |base|
    base.source_files = 'Classes/BaseViewController/**/*.{h,m}'
    base.public_header_files = 'Classes/BaseViewController/*.h'
    base.dependency 'MBProgressHUD', '~> 0.9.1'
    base.dependency 'Reachability', '~> 3.2'
    base.dependency 'PublicProject/Helper'
    base.dependency 'PublicProject/Additions'
    base.dependency 'PublicProject/Macro'
  end
end
